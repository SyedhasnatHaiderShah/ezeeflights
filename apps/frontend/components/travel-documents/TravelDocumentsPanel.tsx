...
export function TravelDocumentsPanel({
  ...
  const scanMutation = useMutation({
    mutationFn: async () => {
      if (!passportScanFile)
        throw new Error("Please choose a passport scan file.");
      return scanPassportDocument(passportScanFile);
    },
    onSuccess: async (result) => {
      setScanResult(result);
      setUploadMessage("Passport scan complete and profile updated.");
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="default" className="font-mono">
            {bookingId ? `Booking: ${bookingId}` : "Secure Vault"}
          </Badge>
        </div>
        <p className="text-muted-foreground">
          Manage your passports, visas, and travel documents in one secure
          place.
        </p>
      </div>
        ...
        <Card className="overflow-hidden border-brand-red/10 shadow-sm">
          <CardHeader className="bg-muted/30 pb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <CardTitle className="text-base">Passport OCR Scan</CardTitle>
                <CardDescription>
                  Auto-fill profile from passport image
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-4 pt-6">
            <div className="space-y-2">
              <Label htmlFor="passport-scan">Passport Image / PDF</Label>
              <Input
                id="passport-scan"
                type="file"
        ...
        <Card className="border-amber-500/20 bg-amber-500/5">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">AI Travel Compliance</CardTitle>
            </div>
            <CardDescription>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Dubai, Paris, Rome"
                />
              </div>
            </div>
            <Button
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All your uploaded travel identification and tickets
          </CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  >
                    <CardContent className="p-4">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        {document.travelerName ?? "Primary Traveler"}
                      </p>
      ...
      <Card>
        <CardHeader className="pb-4">
          <CardTitle className="text-base">Global Share Settings</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="PDF">Secure PDF Link</SelectItem>
        ...
        <CardFooter className="bg-muted/10 border-t py-3">
          <p className="text-[10px] text-muted-foreground italic">
            * These settings will be applied when you click 'Share' on any
            document above.
          </p>
        </CardFooter>
      </Card>

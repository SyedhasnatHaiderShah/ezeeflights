...
export function FAQSection() {
  ...
  return (
    <section className="py-20 bg-background dark:bg-muted/5 border-t border-border/40 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
          <div className="space-y-4 max-w-2xl">
            ...
            <h2 className="text-4xl font-black tracking-tighter text-foreground leading-tight">
              {t("Frequently Asked")} <span className="text-redmix">{t("Questions.")}</span>
            </h2>
            <p className="text-base text-muted-foreground font-medium max-w-xl">
              {t("Get instant answers to the most common queries about booking, changes, and baggage. Can't find what you're looking for? Calls us 24/7.")}
            </p>
          </div>

...
// @ts-ignore
        ...
        caption_label: "text-base font-bold text-foreground dark:text-white tracking-tight",
        ...
        weekdays: "flex mb-1",
        weekday: "text-muted-foreground dark:text-blue-200/70 w-10 h-8 text-[11px] font-semibold text-center flex items-center justify-center",
        week: "flex w-full",
// @ts-ignore
        cell: cn(
...
// @ts-ignore
        day_button: cn(
          "w-10 h-10 p-0 text-foreground dark:text-foreground/90 font-medium rounded-full hover:bg-brand-red/10 hover:text-brand-red transition-colors flex items-center justify-center text-sm cursor-pointer"
        ),
// @ts-ignore
...
// @ts-ignore
        today: "font-bold text-brand-red dark:text-brand-red after:absolute after:bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-1 after:h-1 after:rounded-full after:bg-brand-red",
        outside:

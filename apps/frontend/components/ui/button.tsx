...

  {
    variants: {
      variant: {
        ...
        "ezee-red":
          "bg-[#ff9c00] text-ezee-dark-blue font-bold hover:bg-[#ffbf27] shadow-lg shadow-red-500/20 active:scale-95 transition-all text-lg",

        "ezee-blue":
          "bg-ezee-dark-blue text-white font-bold hover:bg-ezee-red shadow-lg shadow-blue-900/20 active:scale-95 transition-all dark:bg-primary dark:text-[#0f2a5c] dark:hover:bg-primary/90",

        "brand-red":
          "bg-brand-red text-white font-bold hover:bg-brand-red/90 shadow-md transition-all active:scale-95",
      },

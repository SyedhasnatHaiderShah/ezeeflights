...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ...
    className={cn(
      ...
      "data-[state=open]:bg-background data-[state=open]:border-redmix/20",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <div
      className={cn(
        "pb-4 pt-1 text-muted-foreground font-medium leading-relaxed max-w-full accordion-content-inner",
        className,
      )}
    >
      <motion.div

    ...
    <article className="rounded-xl border bg-white p-5 shadow-sm">
      ...
      <p className="mt-3 text-2xl font-bold">
        {plan.pricePerDay
          ...
          : `${plan.currency} ${plan.priceAnnual}/year`}
      </p>
      ...
      <Link
        href={`/insurance/${plan.id}/purchase` as any}
        className="mt-5 inline-block w-full rounded bg-blue-600 px-4 py-2 text-center text-sm font-medium text-white"
      >

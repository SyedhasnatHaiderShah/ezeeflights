...
export function RegisterContainer() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    setError("");
    try {
      await registerRequest({ email, password, firstName: firstName || undefined, lastName: lastName || undefined });
  ...
  return <RegisterForm email={email} password={password} firstName={firstName} lastName={lastName} onEmailChange={setEmail} onPasswordChange={setPassword} onFirstNameChange={setFirstName} onLastNameChange={setLastName} onSubmit={onSubmit} disabled={busy} error={error} />;
}

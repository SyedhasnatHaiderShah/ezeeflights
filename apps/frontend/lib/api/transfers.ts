...
export const bookTransfer=(dto:BookTransferDto)=>apiFetch<TransferBooking>('/transfers/bookings',{method:'POST',body:JSON.stringify(dto)});
export const getMyTransfers=()=>apiFetch<TransferBooking[]>('/transfers/bookings/me');
export const cancelTransfer=(bookingId:string)=>apiFetch<void>(`/transfers/bookings/${bookingId}`,{method:'DELETE'});

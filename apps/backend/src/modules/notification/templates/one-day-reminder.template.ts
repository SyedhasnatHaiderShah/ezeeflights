...
export const oneDayReminderTemplate: NotificationTemplateDefinition = {
        ...
        <tr>
          <td>
            ...
            <p style="margin:0; font-size:13px; color:#475569; line-height:1.5;">
              Exciting times! Your upcoming flight is tomorrow. We wish you safe travels and a wonderful journey!
            </p>
          </td>
        </tr>
      </table>
  ...
  `),
  text: "Hi {{userName}}, your upcoming booking {{bookingRef}} starts tomorrow! Details: {{description}}, Scheduled Date: {{travelDate}}.",
  sms: "Your booking {{bookingRef}} is tomorrow! Have a safe and happy trip.",
  whatsapp:
    "🛫 Your booking {{bookingRef}} is tomorrow! Safe travels and have a wonderful time.",
};

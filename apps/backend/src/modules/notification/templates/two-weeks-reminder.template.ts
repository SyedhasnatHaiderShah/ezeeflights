...
export const twoWeeksReminderTemplate: NotificationTemplateDefinition = {
  subject: "Your trip is in two weeks!",
        ...
        <tr>
          <td>
            ...
            <p style="margin:0; font-size:13px; color:#475569; line-height:1.5;">
              This is a friendly reminder that your upcoming booking is in just two weeks. We hope you are looking forward to your trip!
            </p>
          </td>
        </tr>
      </table>
  ...
  `),
  text: "Hi {{userName}}, your upcoming booking {{bookingRef}} is in two weeks. Details: {{description}}, Scheduled Date: {{travelDate}}.",
  sms: "Your booking {{bookingRef}} is exactly 2 weeks away!",
  whatsapp: "📅 Your booking {{bookingRef}} is exactly 2 weeks away!",
};

...
export const oneMonthReminderTemplate: NotificationTemplateDefinition = {
  subject: 'Your trip is one month away!',
        ...
        <tr>
          <td>
            ...
            <p style="margin:0; font-size:13px; color:#475569; line-height:1.5;">
              This is a friendly reminder that your upcoming booking is exactly one month away! Thank you for choosing ezeeFlights!
            </p>
          </td>
        </tr>
      </table>
  ...
  `),
  text: 'Hi {{userName}}, your upcoming booking {{bookingRef}} is in exactly one month. Details: {{description}}, Scheduled Date: {{travelDate}}.',
  sms: 'Your booking {{bookingRef}} is exactly one month away!',
  whatsapp: '📅 Your booking {{bookingRef}} is exactly one month away!',
};

...
export const inclusionTypeValues = [
  "flight",
  "hotel",
  "meal",
  "activity",
...
export class PackageInclusionDto {
  ...
  @ApiProperty({
    example: "Return flights included",
...
export class CreatePackageDto {
  @ApiProperty({
    example: "Paris Romantic Getaway",
  ...
  @ApiProperty({
    example: "A romantic escape to the city of lights",
  ...
  @ApiProperty({
    example: 1499,
    description: "Base price per person (USD)",
    minimum: 0,
  })
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: "https://cdn.example.com/paris.jpg",
  ...
  @IsOptional()
  @IsEnum(packageStatusValues)
  status?: PackageStatus;

  @ApiPropertyOptional({ example: "London", description: "Origin city" })
  @IsOptional()
  @IsString()
  originCity?: string;
  ...
  @ApiPropertyOptional({
    example: true,
    description: "Whether this is a flash sale",
  })
  @IsOptional()
  @IsBoolean()
  isFlashSale?: boolean;
  ...
  @ApiPropertyOptional({
    ...
    description: "Flash sale expiry time",
  })
  @IsOptional()
  @IsString()
  expiresAt?: string;
  ...
  @ApiPropertyOptional({
    enum: ["package", "flight_deal"],
    description: "Type of entry",
  })
  @IsOptional()
  @IsEnum(["package", "flight_deal"])
  type?: "package" | "flight_deal";

  @ApiProperty({
    type: () => PackagePricingDto,
    description: "Per-traveler-type pricing",
  })
  @ValidateNested()
  @Type(() => PackagePricingDto)
  ...
  @ApiProperty({
    type: [String],
    example: ["Visa fees", "Travel insurance"],
...
export class UpsertItineraryDto {
  ...
  @ApiProperty({
    example: "Arrive at CDG, check in, evening at the Eiffel Tower",
  ...
  @ApiPropertyOptional({
    format: "uuid",
    description: "Hotel UUID for this day",
  })
  @IsOptional()
  @IsUUID()
  hotelId?: string;
...
export class CreatePackageBookingDto {
  @ApiProperty({
    type: [Object],
    example: [{ type: "adult", fullName: "John Doe" }],
  ...
  @ApiProperty({
    enum: ["STRIPE", "PAYTABS", "TABBY", "TAMARA"],
  ...
  @ApiProperty({
    example: "https://yoursite.com/failure",
...
export const packageQuerySchema = z.object({
  ...
  type: z.enum(["package", "flight_deal"]).optional(),
});

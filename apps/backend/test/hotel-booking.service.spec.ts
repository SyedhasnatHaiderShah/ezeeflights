...
describe('HotelBookingService', () => {
    ...
    const moduleRef = await Test.createTestingModule({
      providers: [
        ...
        { provide: AppEventBus, useValue: { emit: jest.fn() } },
        {
          ...
          useValue: {
            getHotelDetails: jest.fn().mockResolvedValue({ name: 'Test Hotel' }),
  ...
  it('create() returns a PENDING booking without charging anything', async () => {
    ...
    const result = await service.create('u1', {
      ...
      guests: [{ firstName: 'Jane', lastName: 'Doe', age: 31, type: 'ADULT', roomId: '22222222-2222-2222-2222-222222222222' }],
    });

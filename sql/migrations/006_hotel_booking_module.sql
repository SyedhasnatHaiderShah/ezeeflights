...
CREATE INDEX IF NOT EXISTS idx_hotel_bookings_city ON hotel_bookings(city);
CREATE INDEX IF NOT EXISTS idx_hotel_bookings_payment_intent_id ON hotel_bookings(payment_intent_id) WHERE payment_intent_id IS NOT NULL;
